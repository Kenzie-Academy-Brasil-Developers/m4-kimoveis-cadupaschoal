...
import { realEstateSchema, createRealEstateSchema, returnRealEstateSchema } from "../schemas";
...
export { IRealEstate, ICreateRealEstate, IReturnRealEstate, IDeepCreateRealEstate };
